...
<html>
    ...
    <body id="s1_enventlist">
        ...
        <div id="Formul_new_event" class="box_window"><?php include("form_new_event.php") ?></div>
        ...
        try {
            ...
            {
            ?>
            <style type="text/css">#eventlist_prochain_section{
            display: none;
            }</style>
            <?php
            }
            ...
            <div id="eventlist_section">
              ...
              <div id="eventlist_prochain_section">
                </br>
            ...
            <?php        // On affiche chaque entrée une à une
              ...
              ?>
                <div id="eventlist_passer_section">
                </br>
              ...
              <?php        // On affiche chaque entrée une à une
               ...
               ?>
               <div id="eventlist_suggestion_section">
                 </br>
